...
//    }
    ...
    bcm2835_pwm_set_range(0,64);   //64 is for 6 bits (maxim)
...
MainWindow::~MainWindow()
{
    ...
    bcm2835_spi_setClockDivider(BCM2835_SPI_CLOCK_DIVIDER_64);//the clock is 4MHz
    bcm2835_spi_chipSelect(BCM2835_SPI_CS0);                      // choose the channel 1 of SPI bus
